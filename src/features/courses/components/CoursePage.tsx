      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Tabs defaultValue="content" className="w-full" dir="rtl">
              ...
              <TabsContent value="content" className="glass-card rounded-xl p-6 mt-4">
              ...
              <TabsContent value="files" className="glass-card rounded-xl p-6 mt-4">
              ...
              <TabsContent value="quiz" className="glass-card rounded-xl p-6 mt-4">
        ...
        {chatOpen && (
          <motion.div
            ...
            className="fixed bottom-6 left-6 w-80 glass-card glow-border rounded-2xl overflow-hidden z-50"
          >
